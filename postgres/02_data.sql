...
BEGIN
    FOR i IN 1..35 LOOP
        EXECUTE format(
            'INSERT INTO space (id, name, minReqGrp, minBookGrp) VALUES (''K-K17-201-%s'', ''K17 201 Desk %s'', ''hdr'', ''hdr'');
            INSERT INTO hotdesk (id, floor, room, deskNumber) VALUES (''K-K17-201-%s'', 2, 201, %s);',
            i, i, i, i
        );
    END LOOP;
    ...
    FOR i IN 1..18 LOOP
        EXECUTE format(
            'INSERT INTO space (id, name, minReqGrp, minBookGrp) VALUES (''K-K17-217-%s'', ''K17 217 Desk %s'', ''hdr'', ''hdr'');
            INSERT INTO hotdesk (id, floor, room, deskNumber) VALUES (''K-K17-217-%s'', 2, 217, %s);',
            i, i, i, i
        );
    END LOOP;
END
