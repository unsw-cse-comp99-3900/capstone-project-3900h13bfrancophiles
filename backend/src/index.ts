...
import { currentBookings, upcomingBookings, pastBookings, rangeOfBookings, currentHotdeskBookings } from './booking/handlers';
...
app.get("/bookings/all/hotdesks", validateToken, currentHotdeskBookings);
