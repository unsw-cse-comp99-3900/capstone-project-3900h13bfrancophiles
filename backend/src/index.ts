...
import { approveBooking, declineBooking, pendingBookings, overlappingBookings, updateConfig } from './admin/handlers';
...
app.put('/admin/config/update', validateToken, authoriseAtLeast('admin'), updateConfig);
